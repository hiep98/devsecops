...
[htt](https://prometheus.io/docs/alerting/latest/notification_examples/)
...
For more information on configuring Prometheus, please see the Prometheus documentation: [https://prometheus.io/docs/prometheus/latest/configuration/](https://prometheus.io/docs/prometheus/latest/configuration/)
...
[h](https://github.com/samber/awesome-prometheus-alerts/blob/master/dist/rules/istio/embedded-exporter.yml)
